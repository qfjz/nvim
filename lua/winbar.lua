...
function M.render()
    -- Colors
    vim.cmd[[highlight WinBar guifg='#87E58E' guibg='#1E1F29']]
    vim.cmd[[highlight WinBarNC guibg='#3E4452']]
    vim.cmd[[highlight WinBarDir guifg='#F6F6B6' guibg='#1E1F29']]
    vim.cmd[[highlight WinBarSeparator guifg='#87E58E' guibg='#1E1F29']]
