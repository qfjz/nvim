...
vim.keymap.set({ 'n', 'x' }, '<leader>P', '"+P')
vim.keymap.set('n', '<leader>gg', function() require('functions').live_grep() end, { desc = 'Live Grep' })
vim.keymap.set('n', '<leader>th', '<cmd>FzfLua helptags<cr>', { desc = 'Pomoc' })
vim.keymap.set('n', '<leader>.', '<cmd>FzfLua oldfiles<cr>', { desc = 'Ostatnio modyfikowane pliki' })
...
vim.keymap.set('n', '-', '<cmd>Oil<cr>', { desc = 'menadżer plików Oil' })
...
vim.keymap.set('n', '<localleader>a', '<cmd>NoiceAll<cr><cmd>norm G<cr>', { desc = 'NoiceAll' })
vim.keymap.set('n', '<localleader>z', '<cmd>xall<cr>', { desc = 'zapisz wszystko i wyjdź' })
...
vim.keymap.set('n', '<leader>st', function()
    require('functions').new_task('~/todo.md')
end, { desc = 'dodaje nowe zadanie do pliku ~/todo.md' })
vim.keymap.set('n', '<leader>sn', function()
    require('functions').choose_tasks_file()
end, { desc = 'dodaj nowe zadanie do wybranego pliku' })
vim.keymap.set('n', '<leader>ss', function() require('functions').select_scratchpad() end, { desc = 'Wybór scratchpad sp-*.md' })
vim.keymap.set('n', '<leader>sf', function() require('functions').floating_obsidian_scratchpad() end, { desc = 'pływające okno Scratchpad.md' })
...
vim.keymap.set('v', 'o', 'o', { desc = 'przechodzi do zaznaczania w odwrotnym kierunku' })
vim.keymap.set('n', [[gcp]], 'O<esc>Vcx<esc><cmd>normal gcc<cr>fxa<bs>', { desc = 'dodaje komentarz linię wyżej' })
vim.keymap.set('n', [[gcn]], 'o<esc>Vcx<esc><cmd>normal gcc<cr>fxa<bs>', { desc = 'dodaje komentarz linię niżej' })
vim.keymap.set('n', [[gci]], 'ix<esc><cmd>normal gcc<cr>fxa<bs>', { desc = 'dodaje komentarz w bieżącej linii' })
